...
public class SignInActivity extends AppCompatActivity implements
    ...
    private static final String TAG = "TAG_"+SignInActivity.class.getCanonicalName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logOut = intent.getBooleanExtra(Utility.EXTRA_LOG_OUT, false);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    // User is signed in
                    Database.static_FirebaseUser = user;
                    if (!logOut) {
                        goToNextActivity();
                    }
                    ...
                    // User is signed out
                    Database.static_FirebaseUser = null;
